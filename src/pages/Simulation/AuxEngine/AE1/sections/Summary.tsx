        ...
        <div className="flex flex-col h-full gap-1 animate-in fade-in duration-500 font-mono">
            ...
            <div className="h-[10%] bg-[#000080] border-2 border-t-[#ffffff40] border-l-[#ffffff40] border-b-black border-r-black flex items-center px-4 justify-between shadow-md">
                <div className="flex items-center gap-6">
                    ...
                    <div className="h-8 w-[1px] bg-[#ffffff30]" />
                    <div className="flex flex-col">
                ...
                <div className="text-right">
                    <span className="text-[9px] text-gray-400 font-bold block uppercase">Health_Index</span>
                ...
                <div className="w-full h-full flex items-center justify-center p-4">
                    <div className="relative w-full h-full border-2 border-dashed border-[#c0c0c0] flex flex-col items-center justify-center bg-white/20">
                        ...
                        >
                            ...
                            <div className="w-10 h-[1px] bg-black group-hover:bg-[#000080]" />
                        </button>
                    </div>
                </div>
            </div>
...
const KPICard = ({ label, value, unit, trend, alert, onClick }: any) => (
    <div
        onClick={onClick}
        className={`border-2 border-inset px-2 py-1 flex flex-col justify-between transition-all cursor-pointer hover:brightness-110 active:border-black ${alert ? 'bg-red-50 border-red-300 shadow-[inset_0_0_10px_rgba(239,68,68,0.2)]' : 'bg-[#eeeeee] hover:border-[#000080]'
            }`}
    >
